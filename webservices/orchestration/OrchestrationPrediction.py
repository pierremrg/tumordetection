...
class OrchestrationPrediction():
	...
	def __init__(self, name_img, list_algo):
	...
	def run(self):
		...
		dir_img_test = 'image_test/'
		dir_img_test_crop = 'image_test_crop/'
		dir_img_test_ready = 'image_test_ready/'
